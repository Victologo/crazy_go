...
function Pf() {
	...
	o.prototype.readUintLE = o.prototype.readUIntLE = function(u, l, E) {
		...
		let C = l + this[++u] * 256 + this[++u] * 2 ** 16 + this[++u] * 2 ** 24, q = this[++u] + this[++u] * 256 + this[++u] * 2 ** 16 + E * 2 ** 24;
		return BigInt(C) + (BigInt(q) << BigInt(32));
	}), o.prototype.readBigUInt64BE = at(function(u) {
		u = u >>> 0, xe(u, "offset");
		let l = this[u], E = this[u + 7];
		(l === void 0 || E === void 0) && st(u, this.length - 8);
		let C = l * 2 ** 24 + this[++u] * 2 ** 16 + this[++u] * 256 + this[++u], q = this[++u] * 2 ** 24 + this[++u] * 2 ** 16 + this[++u] * 256 + E;
		...
		let l = this[u], E = this[u + 7];
		(l === void 0 || E === void 0) && st(u, this.length - 8);
		let C = this[u + 4] + this[u + 5] * 256 + this[u + 6] * 2 ** 16 + (E << 24);
		return (BigInt(C) << BigInt(32)) + BigInt(l + this[++u] * 256 + this[++u] * 2 ** 16 + this[++u] * 2 ** 24);
	}), o.prototype.readBigInt64BE = at(function(u) {
		u = u >>> 0, xe(u, "offset");
		let l = this[u], E = this[u + 7];
		(l === void 0 || E === void 0) && st(u, this.length - 8);
		let C = (l << 24) + this[++u] * 2 ** 16 + this[++u] * 256 + this[++u];
		return (BigInt(C) << BigInt(32)) + BigInt(this[++u] * 2 ** 24 + this[++u] * 2 ** 16 + this[++u] * 256 + E);
...
var Cn = j((dk, Hh) => {
	...
	x();
	I();
	var { MathFloor: v_, NumberIsInteger: S_ } = Ee(), { validateInteger: E_ } = Xr(), { ERR_INVALID_ARG_VALUE: A_ } = De().codes, Fh = 16384, Wh = 16;
	function I_(t, e, r) {
				...
				if (e.length > 2) {
					switch (e.reasonCode = this._parseByte(), this.packet.cmd) {
						...
						case "pubrec":
							...
							break;
						case "pubrel":
						case "pubcomp": if (!pe.MQTT5_PUBREL_PUBCOMP_CODES[e.reasonCode]) return this._emitError(/* @__PURE__ */ new Error("Invalid " + this.packet.cmd + " reason code"));
					}
	...
	var dy = [
		...
		switch (t.log("handlePublish: qos %d", s), s) {
			...
			case 0:
				...
				break;
			default: t.log("handlePublish: unknown QoS. Doing nothing.");
		}
	};
	Da.default = OE;
});
	...
	var V1 = Jn(py()), G1 = Jn(wy()), z1 = Jn(zy()), K1 = Jn(zn()), Q1 = Jn(Ky()), Y1 = (t, e, r) => {
		...
		switch (t.log("_handlePacket :: emitting packetreceive"), t.emit("packetreceive", e), e.cmd) {
			...
			case "disconnect":
				...
				break;
			default: t.log("_handlePacket :: unknown command"), r();
		}
	};
	Yn.default = Y1;
});
			...
			let m = () => {
				...
				switch (s.protocolVersion === 5 && (P.properties = h), this.log("publish :: qos", a), a) {
					...
					case 2:
						...
						break;
					default: this.log("MqttClient:publish: packet cmd: %s", P.cmd), this._sendPacket(P, i, d);
				}
				return !0;
			};
...
function JA() {
	...
	}, g = 35, P = Math.floor, S = String.fromCharCode;
	function b(H) {
...
var _i = j((gr) => {
	...
	var uT = (t, e) => {
		...
		let r, i = iT(e).browserBufferSize || 524288, s = e.browserBufferTimeout || 1e3, o = !e.objectMode, a = sT(t, e), c = h(e, S, b);
...
var getString$1 = (payload, key) => typeof payload[key] === "string" && payload[key] ? payload[key] : void 0;
var hasInvalidSignalField$1 = (payload) => signalKeys$1.some((key) => key in payload && (typeof payload[key] !== "string" || payload[key] === ""));
...
var createSignalHandler = (ctx) => (relayId) => async (topic, msg, signalPeer) => {
	if (ctx.isLeaving()) return;
	const payload = toPayload$1(msg);
	if (!payload || hasInvalidSignalField$1(payload)) return;
	const peerId = getString$1(payload, "peerId") ?? "";
	const offer = getString$1(payload, "offer");
	const answer = getString$1(payload, "answer");
	const candidate = getString$1(payload, "candidate");
	const offerId = getString$1(payload, "offerId");
...
//#endregion
//#region node_modules/@trystero-p2p/core/dist/topic-strategy.mjs
var signalKeys = [
	"offer",
	"answer",
	"candidate"
...
//#endregion
//#region node_modules/@trystero-p2p/mqtt/dist/index.mjs
