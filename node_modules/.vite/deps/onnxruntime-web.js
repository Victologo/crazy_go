...
var qn = ((t) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(t, { get: (e, r) => (typeof __require < "u" ? __require : e)[r] }) : t)(function(t) {
...
var Wt = (t, e) => {
	for (var r in e) Fn(t, r, {
		get: e[r],
		enumerable: !0
	});
};
var Ef = (t, e, r, n) => {
	if (e && typeof e == "object" || typeof e == "function") for (let o of Cf(e)) !Af.call(t, o) && o !== r && Fn(t, o, {
		get: () => e[o],
		enumerable: !(n = If(e, o)) || n.enumerable
	});
	return t;
};
var er = (t) => Ef(Fn({}, "__esModule", { value: !0 }), t);
var Tr;
var kt;
var Pt;
var kf;
...
var jn = V(() => {
	...
	Object.defineProperty(De, "logLevel", { enumerable: !0 });
});
var _e;
var Va = V(() => {
	"use strict";
			...
			if (typeof r == "object") {
				...
				if (Array.isArray(r)) {
					...
					for (let m of this.outputNames) if (p.indexOf(m) !== -1) {
						let g = r[m];
						(g === null || g instanceof je) && (c = !0, a = !1, o[m] = g);
					}
					if (c) {
						if (typeof n == "object" && n !== null) i = n;
						else if (typeof n < "u") throw new TypeError("'options' must be an object.");
	...
	cs && (self.onmessage = (t) => {
		...
		try {
			switch (e) {
				...
				case "end-profiling": Rr(r), postMessage({ type: e });
			}
		} catch (n) {
			postMessage({
				type: e,
...
`));
	...
	if (r || n) {
		...
		n && (d = (s) => {
			...
			if (D(s)) return new Promise((h, f) => {
				...
				$.open("GET", s, !0), $.responseType = "arraybuffer", $.onload = () => {
	...
	var g, y, b, _, S, x, v = console.log.bind(console), T = console.error.bind(console), I = v, E = T, A = !1, D = (s) => s.startsWith("file://");
	function w() {
		...
		let s = function(l) {
			try {
				...
				if (f === "load") {
					...
					})(h.Rc), Rn(h.Rc, 0, 0, 1, 0, 0), qo(), En(h.Rc), U || (Ni(), U = !0);
					try {
						hp(h.Md, h.bd);
					} catch ($) {
						if ($ != "unwind") throw $;
	...
	var N, F, q, Y, z, L, Q, X, Z, ne, ie, le = !1;
	function Me() {
		var s = ht.buffer;
	...
	function M(s) {
		throw E(s = "Aborted(" + s + ")"), A = !0, s = new WebAssembly.RuntimeError(s + ". Build with -sASSERTIONS for more info."), S?.(s), s;
	}
	function G() {
		return { a: {
			ma: Vm,
	...
	async function be() {
		...
		}) : o ? s(new WebAssembly.Instance(y, G()), y) : (ie ??= e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", m) : m + "ort-wasm-simd-threaded.jsep.wasm" : new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href, l = await (async function(f) {
			var $ = ie;
			if (!g && !D($)) try {
	...
	var Ko = (s) => new Promise((l) => {
		s.onmessage = ($) => {
			...
			if ($ = C.Sc, C.Zc && C.Zc != xr()) {
				...
				Fo(Ct[C.Nd]);
			}) : $ === "loaded" ? (s.loaded = !0, l(s)) : C.target === "setimmediate" ? s.postMessage(C) : $ === "uncaughtException" ? s.onerror(C.error) : $ === "callHandler" ? e[C.vd](...C.args) : $ && E(`worker sent an unknown command ${$}`);
		}, s.onerror = ($) => {
	...
	function gp(s) {
		var l = new xn(s >>>= 0);
		return (w(), N)[l.Tc + 12 >>> 0] == 0 && (Zo(l, !0), fr--), Qo(l, !1), mr.push(l), ji(s);
	}
	var Vt = 0, bp = () => {
		ce(0, 0);
		var s = mr.pop();
	...
	var $p = () => {
		...
		var l = s.cd;
		throw (w(), N)[s.Tc + 13 >>> 0] == 0 && (mr.push(s), Qo(s, !0), Zo(s, !1), fr++), Vn(l), Vt = l;
	};
	function vp(s, l, h) {
		var f = new xn(s >>>= 0);
	...
	function Yo(s, l, h, f) {
		...
		var $ = [];
		return o && $.length === 0 ? Xo(s, l, h, f) : (s = {
			Ld: h,
			Rc: s,
			bd: f,
			jd: $
		}, o ? (s.Sc = "spawnThread", postMessage(s, $), 0) : qe(s));
	}
	function Sp(s) {
		throw Vt ||= s >>> 0, Vt;
	}
	...
	var hi = (s, l, h) => {
		switch (l) {
			case 1: return h ? (f) => (w(), N)[f >>> 0] : (f) => (w(), F)[f >>> 0];
			case 2: return h ? (f) => (w(), q)[f >>> 1 >>> 0] : (f) => (w(), Y)[f >>> 1 >>> 0];
			case 4: return h ? (f) => (w(), z)[f >>> 2 >>> 0] : (f) => (w(), L)[f >>> 2 >>> 0];
			case 8: return h ? (f) => (w(), Z)[f >>> 3 >>> 0] : (f) => (w(), ne)[f >>> 3 >>> 0];
			default: throw new TypeError(`invalid integer width (${l}): ${s}`);
		}
	};
	function Cp(s, l, h, f, $) {
		s >>>= 0, h >>>= 0, l = Je(l >>> 0);
	...
	var Pp = (s, l) => {
		switch (l) {
			...
			default: throw new TypeError(`invalid float width (${l}): ${s}`);
		}
	};
	function Op(s, l, h) {
		h >>>= 0, lt(s >>>= 0, {
	...
	function qp(s, l) {
		(s >>>= 0) == l >>> 0 ? setTimeout(br) : o ? postMessage({
			Zc: s,
			Sc: "checkMailbox"
	...
	var bt = 0, et = null, yi = 0, _r = [], Pn = /* @__PURE__ */ new Map(), _i = /* @__PURE__ */ new Map(), wi = /* @__PURE__ */ new Map(), Yp = 0, On = null, Jp = [], $i = (s) => (function(l) {
		if (!A) {
			if (bt === 0) {
				...
				l(($ = 0) => {
					if (!A && (yi = $, h = !0, f)) {
						bt = 2, yr(() => Da(et)), typeof MainLoop < "u" && MainLoop.ud && MainLoop.resume(), $ = !1;
						try {
							var C = (function() {
								var H = (w(), z)[et + 8 >>> 2 >>> 0];
						...
						if (!et) {
							var B = On;
							B && (On = null, ($ ? B.reject : B.resolve)(C), P = !0);
						}
						if ($ && !P) throw C;
					}
	...
	function im(s, l, h) {
		...
		switch (s = C.map((H, K) => {
			...
			case 3:
				B = "";
				break;
			case 1: P.getStringOrSymbol = wr, B = "toValue(handle)[getStringOrSymbol(methodName)]";
		}
  ...
  ${B}
	...
	function ym(s, l) {
		s = -9007199254740992 > s || 9007199254740992 < s ? NaN : Number(s), l >>>= 0, s = /* @__PURE__ */ new Date(1e3 * s), (w(), z)[l >>> 2 >>> 0] = s.getUTCSeconds(), (w(), z)[l + 4 >>> 2 >>> 0] = s.getUTCMinutes(), (w(), z)[l + 8 >>> 2 >>> 0] = s.getUTCHours(), (w(), z)[l + 12 >>> 2 >>> 0] = s.getUTCDate(), (w(), z)[l + 16 >>> 2 >>> 0] = s.getUTCMonth(), (w(), z)[l + 20 >>> 2 >>> 0] = s.getUTCFullYear() - 1900, (w(), z)[l + 24 >>> 2 >>> 0] = s.getUTCDay(), s = (s.getTime() - Date.UTC(s.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0, (w(), z)[l + 28 >>> 2 >>> 0] = s;
	}
	var xi = (s) => s % 4 == 0 && (s % 100 != 0 || s % 400 == 0), Si = [
		0,
		31,
		60,
		91,
	...
	function _m(s, l) {
		s = -9007199254740992 > s || 9007199254740992 < s ? NaN : Number(s), l >>>= 0, s = /* @__PURE__ */ new Date(1e3 * s), (w(), z)[l >>> 2 >>> 0] = s.getSeconds(), (w(), z)[l + 4 >>> 2 >>> 0] = s.getMinutes(), (w(), z)[l + 8 >>> 2 >>> 0] = s.getHours(), (w(), z)[l + 12 >>> 2 >>> 0] = s.getDate(), (w(), z)[l + 16 >>> 2 >>> 0] = s.getMonth(), (w(), z)[l + 20 >>> 2 >>> 0] = s.getFullYear() - 1900, (w(), z)[l + 24 >>> 2 >>> 0] = s.getDay();
...
`))[0] == "Error" && f.shift(), ki(f);
	...
	o || (function() {
		...
		maximum: 65536,
		shared: !0
	}), Me()), e.wasmBinary && (g = e.wasmBinary), e.stackSave = () => de(), e.stackRestore = (s) => ue(s), e.stackAlloc = (s) => Nn(s), e.setValue = function(s, l, h = "i8") {
		...
		switch (l.endsWith("*") && (l = "*"), l) {
			case "i1":
			case "i8": return (w(), N)[s >>> 0];
			case "i16": return (w(), q)[s >>> 1 >>> 0];
			case "i32": return (w(), z)[s >>> 2 >>> 0];
			case "i64": return (w(), Z)[s >>> 3 >>> 0];
			case "float": return (w(), Q)[s >>> 2 >>> 0];
			case "double": return (w(), X)[s >>> 3 >>> 0];
			case "*": return (w(), L)[s >>> 2 >>> 0];
			default: M(`invalid type for getValue: ${l}`);
		}
	}, e.UTF8ToString = Ee, e.stringToUTF8 = gt, e.lengthBytesUTF8 = hr;
	var Ui, Ni, xr, tt, Yt, Rn, Vi, Li, Wi, Un, Gi, Hi, ce, Jt, Fi, ue, Nn, de, qi, Vn, Ki, ji, Zi, Ln, Qi, Xi, Yi, Ji, ea, ta, ra, na, oa, ia, aa, sa, ua, da, la, ca, pa, ma, fa, ha, ga, ba, ya, _a, wa, $a, va, xa, Sa, Ta, Ia, Ca, Aa, Ea, ka, Pa, Oa, Da, za, ct, Um = [
		pr,
		Go,
		Xo,
		ri,
		...
		1056577: (s) => e.Ed(s),
		1056609: (s, l, h) => {
			e.ed(Number(s), Number(l), Number(h), !0);
		},
		1056672: (s, l, h) => {
			e.ed(Number(s), Number(l), Number(h));
		},
		1056729: () => typeof wasmOffsetConverter < "u",
		1056786: (s) => {
			e.$b("Abs", s, void 0);
		},
		1056837: (s) => {
		...
		1059133: (s, l, h, f, $) => {
			e.$b("ReduceMean", s, {
				keepDims: !!l,
				noopWithEmptyAxes: !!h,
				axes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : []
			});
		},
		1059308: (s, l, h, f, $) => {
			e.$b("ReduceMax", s, {
		...
		1061423: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt) => {
			e.$b("ConvTranspose", s, {
				...
				strides: [B],
				wIsConst: () => !!(w(), N)[K >>> 0],
				outputPadding: ae ? Array.from((w(), z).subarray(Number(ae) >>> 0, Number(pe) >>> 0)) : [],
				outputShape: xe ? Array.from((w(), z).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [],
				activation: Ee(yt)
			});
		},
		1061856: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
			e.$b("ConvTranspose", s, {
				format: B ? "NHWC" : "NCHW",
				autoPad: l,
				dilations: Array.from((w(), z).subarray(Number(h) >>> 0, (Number(h) >>> 0) + 2 >>> 0)),
				group: f,
				kernelShape: Array.from((w(), z).subarray(Number($) >>> 0, (Number($) >>> 0) + 2 >>> 0)),
				pads: Array.from((w(), z).subarray(Number(C) >>> 0, (Number(C) >>> 0) + 4 >>> 0)),
				strides: Array.from((w(), z).subarray(Number(P) >>> 0, (Number(P) >>> 0) + 2 >>> 0)),
				wIsConst: () => !!(w(), N)[H >>> 0],
				outputPadding: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [],
				outputShape: pe ? Array.from((w(), z).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [],
				activation: Ee(Ie)
			});
		},
		...
		1063702: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie) => {
			e.$b("AveragePool", s, {
				...
				count_include_pad: f,
				storage_order: $,
				dilations: C ? Array.from((w(), z).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [],
				kernel_shape: B ? Array.from((w(), z).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [],
				pads: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [],
				strides: pe ? Array.from((w(), z).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : []
			});
		},
		1064181: (s, l) => {
			e.$b("GlobalAveragePool", s, { format: l ? "NHWC" : "NCHW" });
		...
		1066372: (s, l, h, f, $) => {
			e.$b("Split", s, {
				axis: l,
				numOutputs: h,
				splitSizes: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : []
			});
		},
		1066528: (s) => {
			e.$b("Expand", s, void 0);
		...
		1066811: (s, l, h, f, $, C, P, B, H, K, ae) => {
			e.$b("Resize", s, {
				antialias: l,
				axes: h ? Array.from((w(), z).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [],
				coordinateTransformMode: Ee($),
				cubicCoeffA: C,
				excludeOutside: P,
				extrapolationValue: B,
				keepAspectRatioPolicy: Ee(H),
				mode: Ee(K),
				nearestMode: Ee(ae)
			});
		},
		1067173: (s, l, h, f, $, C, P) => {
			e.$b("Slice", s, {
				starts: l ? Array.from((w(), z).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [],
				ends: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : [],
				axes: C ? Array.from((w(), z).subarray(Number(C) >>> 0, Number(P) >>> 0)) : []
			});
		},
		1067437: (s) => {
			e.$b("Tile", s, void 0);
		...
		1067851: (s, l, h, f, $) => {
			e.$b("Pad", s, {
				mode: l,
				value: h,
				pads: f ? Array.from((w(), z).subarray(Number(f) >>> 0, Number($) >>> 0)) : []
			});
		},
		1067994: (s, l, h, f, $, C) => {
			e.$b("BatchNormalization", s, {
				epsilon: l,
				momentum: h,
				spatial: !!$,
				trainingMode: !!f,
		...
		1068944: (s, l, h, f, $, C, P, B, H) => {
			e.$b("Attention", s, {
				...
				scale: $,
				doRotary: C,
				qkvHiddenSizes: P ? Array.from((w(), z).subarray(Number(B) >>> 0, Number(B) + P >>> 0)) : [],
		...
		1069388: (s, l, h, f, $, C, P, B, H, K, ae, pe, xe, Ie, yt, Gn) => {
			e.$b("Conv", s, {
				format: pe ? "NHWC" : "NCHW",
				auto_pad: l,
				dilations: h ? Array.from((w(), z).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [],
				group: $,
				kernel_shape: C ? Array.from((w(), z).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [],
				pads: B ? Array.from((w(), z).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [],
				strides: K ? Array.from((w(), z).subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [],
				w_is_const: () => !!(w(), N)[Number(xe) >>> 0],
				activation: Ee(Ie),
				activation_params: yt ? Array.from((w(), Q).subarray(Number(yt) >>> 0, Number(Gn) >>> 0)) : []
			});
		},
		1069972: (s) => {
			e.$b("Gelu", s, void 0);
	...
	function Sr() {
		if (0 < ge) Te = Sr;
			...
			0 < ge ? Te = Sr : (e.calledRun = !0, A || ($e(), _?.(e)));
		}
	}
...
var kr = V(() => {
	...
	_s = typeof location > "u" ? void 0 : location.origin, to = import.meta.url > "file:" && import.meta.url < "file;", Bf = () => {
		if (to) return new URL(new URL("ort.bundle.min.mjs", import.meta.url).href, _s).href;
...
var $t = V(() => {
	...
	no = !1, Nr = !1, Ss = !1, Nf = () => {
		...
		let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, a = o?.mjs, u = a?.href ?? a, d = o?.wasm, c = d?.href ?? d, p = t.wasmBinary, [m, g] = await xs(u, i, r > 1, !!p || !!c), y = !1, b = [];
		if (e > 0 && b.push(new Promise((_) => {
			...
			g(x).then((v) => {
				Nr = !1, no = !0, ro = v, _(), m && URL.revokeObjectURL(m);
			}, (v) => {
				Nr = !1, Ss = !0, S(v);
			});
...
var nt = V(() => {
	...
	qf = [
		...
		let r = or(t);
		r >= or(Es) && Kf(r, typeof e == "function" ? e() : e);
	}, se = (...t) => {
		ks && jf(...t);
	};
});
...
var te = V(() => {
	...
	ao = class {
		...
		static computeConvOutputShape(e, r, n, o, i, a, u) {
			...
			let d = [e[0], r[0]];
			return t.computeShapeHelper(!1, e, d, n, o, i, a, u), d;
		}
		...
		static adjustPadAndReturnShape(e, r, n, o, i, a, u, d, c = 0) {
			...
			if (d && d !== "NOTSET") switch (d) {
				case "VALID": return i[a] = 0, i[u] = 0, t.computeOutputSize(e - p, r, e, 0, c);
				case "SAME_LOWER":
				case "SAME_UPPER":
...
var Us = V(() => {
	...
	zs = /* @__PURE__ */ new Map([
	...
	}, Qf = 1, Ds = () => Qf++, Xf = /* @__PURE__ */ new Map([
		["int8", "int32"],
		["uint8", "int32"],
		["uint32", "int32"],
		["int64", "int32"]
		...
		upload(e) {
			let r = e;
			if (this.wrapper) {
				if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") r = Zf(e, this.wrapper.type), this.wrapper.setIsDataConverted(!0);
		...
		registerTensor(e, r, n, o) {
			let i = this.getMLContext(e), a = Ds(), u = new qr({
				sessionId: e,
				context: i,
				tensor: r,
				dataType: n,
...
var Hs = V(() => {
	...
	Vs = /* @__PURE__ */ new Map([
		...
		[134217728, 6],
		[167772160, 6]
	]), lo = [], co = (t) => Math.ceil(Number(t) / 16) * 16, Jf = (t) => {
		...
		let o = co(r), i = t.device.createBuffer({
			size: o,
...
var oe = V(() => {
	...
	Bt = 64, go = (t, e) => {
		...
		let i = typeof r == "number", a = i ? r : r.length, u = [...new Array(a).keys()], d = a < 2 ? "u32" : a <= 4 ? `vec${a}<u32>` : `array<u32, ${a}>`, c = go(e, o), p = typeof c == "string" ? c : c[1], g = {
			indices: d,
			value: p,
			...
			get: !1,
			getByIndices: !1
		}, _ = i ? "uniforms." : "", S = `${_}${t}_shape`, x = `${_}${t}_strides`, v = "";
  ...
  fn o2i_${t}(offset: u32) -> ${g.indices} {
    ...
    ${v}
    return indices;
  }`, I = (M) => (b.offsetToIndices = !0, a < 2 ? M : `o2i_${t}(${M})`), E = [];
		if (a >= 2) for (let M = a - 1; M >= 0; M--) E.push(`${j(x, M, a)} * (indices[${M}])`);
		let A = a < 2 ? "" : `
  fn i2o_${t}(indices: ${g.indices}) -> u32 {
    return ${E.join("+")};
  }`, D = (M) => (b.indicesToOffset = !0, a < 2 ? M : `i2o_${t}(${M})`), w = (...M) => a === 0 ? "0u" : `${g.indices}(${M.map(y).join(",")})`, U = (M, G) => a < 2 ? `${M}` : `${j(M, G, a)}`, N = (M, G, be) => a < 2 ? `${M}=${be};` : `${j(M, G, a)}=${be};`, F = {}, q = (M, G) => {
  ...
  fn get_${t}(${M}) -> ${p} {
    return get_${t}ByIndices(${w(G)});
			...
			let G = M.map(y).join(",");
			return a === 0 ? z("0u") : a === 1 ? z(G[0]) : (b.get = !0, b.getByIndices = !0, b.indicesToOffset = !0, `get_${t}(${G})`);
		}, Z = (M) => a < 2 ? z(M) : (b.getByIndices = !0, b.indicesToOffset = !0, `get_${t}ByIndices(${M})`), ne = a < 2 ? "" : `
  ...
  fn set_${t}(${M}, value: ${p}) {
    set_${t}ByIndices(${w(G)}, value);
		...
		return {
			impl: () => {
				let M = [], G = !1;
				return b.offsetToIndices && (M.push(T), G = !0), b.indicesToOffset && (M.push(A), G = !0), b.broadcastedIndicesToOffset && (Object.values(F).forEach((be) => M.push(be)), G = !0), b.set && (M.push(ie), G = !0), b.setByIndices && (M.push(ne), G = !0), b.get && (M.push(Q), G = !0), b.getByIndices && (M.push(L), G = !0), !i && G && M.unshift(`const ${S} = ${g.indices}(${r.join(",")});`, `const ${x} = ${g.indices}(${k.computeStrides(r).join(",")});`), M.join(`
`);
			},
			type: g,
			offsetToIndices: I,
			...
			set: (...M) => {
				...
				return a === 0 ? Y("0u", G) : a === 1 ? Y(be[0], G) : (b.set = !0, b.setByIndices = !0, b.indicesToOffset = !0, `set_${t}(${be}, ${G})`);
			},
			setByOffset: Y,
			setByIndices: (M, G) => a < 2 ? Y(M, G) : (b.setByIndices = !0, b.indicesToOffset = !0, `set_${t}ByIndices(${M}, ${G});`),
			get: X,
			getByOffset: z,
			getByIndices: Z,
			usage: n,
...
var pt = V(() => {
  ...
  ${_.mainStart()}
    ...
    output[global_idx] = input[global_idx];
		...
		let { newShape: p, newPerm: m } = oh(t.dims, o), g = k.areEqual(m, [
			2,
			3,
			1
		]), y = k.areEqual(m, [
  ...
  var<workgroup> tile : array<array<${v.type.value}, 17>, ${_}>;
  ${S.mainStart([
					_,
					_,
					1
...
var au = V(() => {
	...
	ah = {
       ...
       `, b = (_) => `
		...
		c.length > 0 && (d = t.compute(ze(t.inputs[0], c), {
			inputs: [0],
			outputs: [-1]
		})[0], u = lh(u.length, d.dims.length));
...
`)}
		...
		let r = [];
		return t[1].dims[0] > 0 && t[1].getBigInt64Array().forEach((n) => r.push(Number(n))), J({
			axes: r,
			keepDims: e.keepDims,
		...
		t.compute(en(e, {
			hint: i.cacheKey,
			inputDependencies: ["rank"]
		}, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? gh : n, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
	}, bh = (t, e) => {
...
var tn = V(() => {
    ...
    `, Ah = (t, e, r, n, o, i, a, u) => {
		...
		], y = we(t.dataType, d), b = Ae(1, d), _ = ["type"];
    ...
    if (sum == 0) {
      ...
      ${a ? `
		...
		let c = a + i.kvSequenceLength, p = [
			...
			c,
			i.headSize
		] : void 0, b = i.nReps ? i.nReps : 1, _ = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale, S = fe(i.headSize), x = i.headSize / S, v = 12, T = {
			x: Math.ceil(c / v),
  ...
  ${U.mainStart([
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
		...
		], v = m && n && k.size(n.dims) > 0, T = ["type", "type"];
		...
		let E = (A) => {
			let D = O("probs", e.dataType, e.dims), U = [D, O("v", r.dataType, r.dims)];
			...
			return `
  const TILE_SIZE = ${_}u;
  var<workgroup> tileQ: array<${D.type.value}, 144>;
  var<workgroup> tileV: array<${D.type.value}, 144>;
  ${A.registerUniforms([
				{
					name: "M",
					type: "u32"
  ...
  ${A.mainStart([
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
		...
		let T = t.compute(Eh(g, e, r, y, x, c, _, p, m), {
			inputs: v,
			outputs: g > 1 ? [-1, 1] : [-1]
		})[0];
		t.compute(Ah(T, c.batchSize, c.numHeads, _, c.sequenceLength, S, p, m), {
			inputs: p && m ? [
				T,
				p,
				m
		...
		let I = [T, n];
		b && k.size(b.dims) > 0 && I.push(b), p && I.push(p), m && I.push(m), t.compute(kh(g, T, n, b, c, _, p, m), {
			inputs: I,
			outputs: g > 1 ? [0, 2] : [0]
		});
	}, Ph = (t, e) => {
		let r = [
			...
			e.sequenceLength,
			e.headSize
		], n = e.sequenceLength, o = e.inputHiddenSize, i = e.headSize, a = 12, u = {
			x: Math.ceil(e.headSize / a),
			y: Math.ceil(e.sequenceLength / a),
			...
			let g = R("output_q", d[0].dataType, r), y = R("output_k", d[0].dataType, r), b = R("output_v", d[0].dataType, r), _ = O("input", d[0].dataType, d[0].dims), S = O("weight", d[1].dataType, d[1].dims), x = O("bias", d[2].dataType, d[2].dims), v = _.type.storage;
			return `
  const TILE_SIZE = ${a}u;
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${S.setByOffset("global_idx", "value")}
		...
		return {
			...
			shaderCache: {
				hint: `${e.epsilon}_${e.format}_${n}_${a}`,
				inputDependencies: c ? [
					"rank",
					"type",
					"type",
		...
		let { inputs: r, outputCount: n } = t, o = zh({
			...e,
			outputCount: n
		});
  ...
  ${t.mainStart()}
    ...
    ${p.setByOffset("global_idx", d)}
		...
		return a && d.push(...a), {
			...
			getShaderSource: (c) => Rh(c, k.size(t.dims), t.dataType, i, r, n, u),
			getRunData: (c) => ({
				outputs: [{
					dims: t.dims,
					dataType: i
...
var vd = V(() => {
	...
	Gh = (t, e, r, n, o, i, a, u, d, c, p, m) => {
		...
		return b.push(g), {
			...
			getShaderSource: (_) => Gh(_, u, d, p, g, c, y, o, r.dataType, n.dataType, a, i),
			getRunData: () => ({
				outputs: [{
					dims: p,
					dataType: a
...
`);
		...
		let o = k.size(r), i = new Array(t.length), a = new Array(t.length), u = 0, d = [], c = [], p = [{
			type: 12,
			data: o
		}];
		for (let _ = 0; _ < t.length; ++_) u += t[_].dims[e], i[_] = u, c.push(t[_].dims.length), a[_] = O(`input${_}`, n, c[_]), d.push("rank"), p.push({
			type: 12,
			data: i[_]
		});
...
`;
		...
		let a = t[0].dims, u = t[1].dims, d = a[a.length - 2], c = u[u.length - 1], p = a[a.length - 1], m = fe(c), g = fe(p), y = fe(d), b = k.size(r) / m / y, _ = t.length > 2, S = n ? n.slice(0, -2) : r.slice(0, -2), v = [
			k.size(S),
			d,
			c
		], T = [
...
var dn = V(() => {
	...
	Qh = (t, e) => t ? `
        ...
        }`, xo = (t, e, r = "f32", n, o = !1, i = 32, a = !1, u = 32) => {
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, Yh = (t) => t ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", So = (t, e, r = "f32", n, o = !1, i = 32, a = !1, u = 32, d = !1) => {
...
`;
    ...
    `;
		...
		let a = t[0].dims, u = t[1].dims, d = a.slice(0, -2), c = u.slice(0, -2), p = n ? n.slice(0, -2) : r.slice(0, -2), m = k.size(p), g = a[a.length - 2], y = a[a.length - 1], b = u[u.length - 1], _ = y % 4 === 0 && b % 4 === 0, S = g <= 8 ? [
			4,
			1,
			1
		] : [
		...
		let q = (Y) => {
			...
			Ye(e, le);
			let Me = we(ne.type.tensor), $e = Qe(e, ne.type.value, Me), M = Jh(T, F, $e, [
				L,
				X,
				Z,
				ne
...
var Pd = V(() => {
	...
	Ad();
	dn();
	eg = (t, e, r, n, o = !1, i, a = 4, u = 4, d = 4, c = "f32") => {
		let p = (N) => {
			switch (N) {
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
		...
		let c = e.format === "NHWC", p = c ? t[0].dims[3] : t[0].dims[1], m = r[0], g = c ? r[2] : r[3], y = c ? r[1] : r[2], b = c ? r[3] : r[1], _ = c && (p % 4 === 0 || p % 3 === 0) && b % 4 === 0, S = c ? b : g * y, x = c ? g * y : b, v = [
			8,
			8,
			1
		], T = n <= 8 ? [
		...
		let E = _ ? c && p % 4 !== 0 ? 3 : 4 : 1, A = v[1] * T[1], D = v[0] * T[0], w = Math.max(v[0] * E, v[1]), U = n % A === 0, N = o % D === 0, F = i % w === 0, q = _ ? [
			E,
			4,
			4
		] : [
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${_ ? `vec4<${ne}>` : ne}) {
      ...
      }`, $e = [O("x", t[0].dataType, t[0].dims.length, E === 3 ? 1 : E), O("w", t[1].dataType, t[1].dims.length, Z)], M = R("result", t[0].dataType, r.length, Z);
			if (a) {
        ...
        ${_ ? xo(T, v, ne, void 0, !c, w) : So(T, v, ne, void 0, !c, w, !1, void 0, u)}`;
		};
		return {
			name: "Conv2DMatMul",
			shaderCache: {
				hint: `${e.cacheKey};${E};${_};${U};${N};${F};${A};${D};${w}`,
				inputDependencies: z
			},
			getRunData: () => ({
				outputs: [{
...
var Md = V(() => {
	...
	tg = (t) => {
		...
		return e;
	}, Od = (t) => typeof t == "number" ? [
		t,
		t,
		t
	] : t, ln = (t, e) => e <= 1 ? t : t + (t - 1) * (e - 1), rg = (t, e, r, n = 1) => {
		let o = ln(e, n);
		...
		if (t === "VALID" && (t = 0), typeof t == "number") {
			...
			let b = (m - 1) * o + u - e, _ = (g - 1) * i + d - r, S = (y - 1) * a + c - n, x = Math.floor(b / 2), v = b - x, T = Math.floor(_ / 2), I = _ - T, E = Math.floor(S / 2);
			p = {
				top: T,
				bottom: I,
				left: E,
	...
	}, zd = (t, e, r, n, o, i = !1, a = "channelsLast") => {
		let u, d, c, p, m;
		if (a === "channelsLast") [u, d, c, p, m] = t;
		else if (a === "channelsFirst") [u, m, d, c, p] = t;
		else throw new Error(`Unknown dataFormat ${a}`);
		let [g, , y, b, _] = e, [S, x, v] = Od(r), [T, I, E] = Od(n), A = ln(y, T), D = ln(b, I), w = ln(_, E), { padInfo: U, outDepth: N, outHeight: F, outWidth: q } = ng(o, d, c, p, S, x, v, A, D, w), Y = i ? g * m : g, z = [
			0,
			0,
			0,
			0,
		...
		a ? t[0].dims[3] : t[0].dims[1];
		let c = [
			64,
			1,
			1
		], p = { x: r.map((v, T) => T) }, m = [
			Math.ceil(tg(p.x.map((v) => r[v])) / c[0]),
			1,
			1
		];
		...
		let x = (v) => {
			...
			Ye(e, T);
			let I = 1, E = we(t[0].dataType), A = O("x", t[0].dataType, t[0].dims.length, g), D = O("W", t[1].dataType, t[1].dims.length, I), w = [A, D], U = R("result", t[0].dataType, r.length, I), N = "";
			if (S) {
...
var Nd = V(() => {
	...
	St();
	Rd = (t, e, r, n) => {
		let o = t.length > 2, i = o ? "value += b[output_channel];" : "", a = t[0].dims, u = t[1].dims, d = e.format === "NHWC", c = d ? r[3] : r[1], p = c / e.group, m = d && p >= 4 ? fe(c) : 1, g = k.size(r) / m, y = [
			{
				type: 12,
				data: g
			},
  ...
  ${S.mainStart()}
    ...
    ${x.setByOffset("global_idx", "value")}
		...
		let o = t.length > 2, i = fe(r[3]), a = fe(r[2]), u = k.size(r) / i / a, d = [
			t[0].dims[0],
			t[0].dims[1],
			t[0].dims[2],
			t[0].dims[3] / i
...
var Ld = V(() => {
	...
	og = (t, e, r, n, o, i) => {
		...
		if (r.group !== 1) {
			let A = [e[0]];
			if (o) {
				let w = t.kernelCustomData.wT ?? t.compute(ze(e[1], To), {
					inputs: [1],
		...
		if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
			let A = i[0], D, w, U, N = [];
			if (o) {
				let Y = t.kernelCustomData.wT ?? t.compute(ze(e[1], To), {
					inputs: [1],
					outputs: [r.wIsConst ? -2 : -1]
				})[0];
		...
		let S = !0, x = t.kernelCustomData.wT ?? t.compute(ze(e[1], To), {
			inputs: [1],
			outputs: [r.wIsConst ? -2 : -1]
		})[0];
		...
		let o = [
			...
			0,
			e.pads[1]
		], i = [1].concat(e.strides), a = [1].concat(e.dilations), u = [1].concat(e.kernelShape), d = Io({
			...e,
			pads: o,
			strides: i,
			dilations: a,
		...
		let n = r.format === "NHWC" ? "channelsLast" : "channelsFirst", o = Io(r, e), i = r.autoPad === "NOTSET" ? r.pads : r.autoPad, a = zd(e[0].dims, e[1].dims, r.strides, r.dilations, i, !1, n);
		t.compute(Bd(e, o, a.outShape, [
			a.filterDepth,
			a.filterHeight,
			a.filterWidth
		], [
...
var Gd = V(() => {
	...
	oe();
	Wd = (t, e, r) => {
		let n = t.length > 2, o = e.outputShape, i = e.format === "NHWC", a = e.group, u = t[1].dims, d = u[2] / a, c = u[3], p = i ? fe(d) : 1, m = i && c === 1 && d >= 4, g = m ? Math.floor(d / 4) * 4 : Math.floor(d / p) * p, y = d - g, b = i ? fe(c) : 1, _ = i ? c === 1 ? p : b : 1, S = k.size(o) / b, x = [
			Math.ceil(S / 64),
			1,
			1
		];
		se("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${x}`);
		let v = ["rank", "rank"], T = [e.strides[0], e.strides[1]], I = [e.kernelShape[i ? 1 : 2], e.kernelShape[i ? 2 : 3]], E = [e.dilations[0], e.dilations[1]], A = [I[0] + (e.dilations[0] <= 1 ? 0 : (e.kernelShape[i ? 1 : 2] - 1) * (e.dilations[0] - 1)), I[1] + (e.dilations[1] <= 1 ? 0 : (e.kernelShape[i ? 2 : 3] - 1) * (e.dilations[1] - 1))], D = [A[0] - 1 - Math.floor((e.pads[0] + e.pads[2]) / 2), A[1] - 1 - Math.floor((e.pads[1] + e.pads[3]) / 2)], w = [
			{
				type: 12,
				data: S
			},
		...
		let U = (N) => {
			...
			], q = we(t[0].dataType), Y = i ? 1 : 2, z = i ? 2 : 3, L = i ? 3 : 1, Q = O("W", t[1].dataType, t[1].dims.length, _), X = O("Dy", t[0].dataType, t[0].dims.length, p), Z = [X, Q];
...
var jd = V(() => {
	...
	ug = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i, dg = (t, e, r, n, o) => {
		...
		let e = on(t), r = t.format, n = [
			"NOTSET",
			"VALID",
			"SAME_UPPER",
			"SAME_LOWER"
		][typeof t.autoPad > "u" ? 0 : t.autoPad], o = t.dilations, i = t.group ?? 1, a = t.kernelShape, u = t.pads, d = t.strides, c = t.wIsConst();
		return {
			autoPad: n,
			format: r,
			dilations: o,
		...
		let o = t.kernelCustomData.wT ?? t.compute(ze(e[1], [
			2,
			3,
			0,
			1
		...
		u.length === 0 && (u = [0, 0]), u = [
			...
			0,
			u[1]
		], a = [1].concat(a), i = [1].concat(i), o = [1].concat(o);
		...
		return {
			...
			getRunData: (x) => {
				let v = d ? [
					...
					n * c,
					o * c
				], T = k.size(v), I = m.dims, E = k.sortBasedOnPerm(I, u);
				return {
					outputs: [{
						dims: v,
...
`;
	...
	], il = (t, e, r) => t.registerUniform("batch", "u32").registerUniform("signalLength", "u32").registerUniform("inner", "u32").registerUniform("outputLength", "u32").declareVariables(e, r), wg = (t) => {
		let { dataType: e, length: r, inputComponents: n, outputComponents: o, inverse: i, onesided: a } = t, u = Ae(e), d = i ? 1 : -1, c = i ? 1 / r : 1, p = rl(r), m = (g) => {
			let y = O("x", e, [1]), b = R("y", e, [1]), _ = (E) => {
				let A = `inBase + (${E}) * uniforms.inner * ${n}u`;
				return `vec2<f32>(${`f32(${y.getByOffset(A)})`}, ${n === 2 ? `f32(${y.getByOffset(`${A} + 1u`)})` : "0.0"})`;
			}, S;
			if (i && a) {
      ...
      ${I}
		...
		return {
			...
			getRunData: () => ({
				...
				programUniforms: ol(t),
				dispatchGroup: { x: t.batch }
			})
		};
	}, $g = (t) => {
		let { dataType: e, length: r, inputComponents: n, outputComponents: o, inverse: i, onesided: a } = t, u = Ae(e), d = i ? 1 : -1, c = i ? 1 / r : 1, p = (m) => {
			let g = O("x", e, [1]), y = R("y", e, [1]), b = (T) => {
				let I = `inBase + (${T}) * uniforms.inner * ${n}u`;
				return `vec2<f32>(${`f32(${g.getByOffset(I)})`}, ${n === 2 ? `f32(${g.getByOffset(`${I} + 1u`)})` : "0.0"})`;
...
var $l = V(() => {
	...
	kg = (t) => {
		...
		a.splice(i, 1, ...n);
		let u = r[i], d = t[0].dataType === 9 ? 4 : 1, c = Math.ceil(k.size(a) / d), p = [
			{
				type: 12,
				data: c
			},
...
var Sl = V(() => {
	...
	Og = (t, e, r, n, o, i, a, u, d) => {
		...
		c.push(...W(e.dims, p));
		let m = (g) => {
			let _ = [O("indices_data", e.dataType, e.dims.length), R("input_slice_offsets_data", 12, 1, 1)], S = [
				{
					name: "output_size",
					type: "u32"
				},
  ...
  ${g.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
		...
		let S = i.slice(0, -1).concat(n.slice(_)), x = k.size(S), v = [
			{
				type: 12,
				data: x
			},
...
var Cl = V(() => {
	...
	Dg = (t, e) => {
		...
		let d = k.size(u), c = t[2].dataType, m = t[0].dataType === 22, g = [
			...
			let _ = O("data", t[0].dataType, t[0].dims.length), S = O("inputIndices", t[1].dataType, t[1].dims.length), x = O("scales", t[2].dataType, t[2].dims.length), v = t.length > 3 ? O("zeroPoint", t[3].dataType, t[3].dims.length) : void 0, T = R("output", c, u.length), I = [
				_,
				S,
				x
			];
...
var kl = V(() => {
	...
	Bg = (t) => {
		...
		let r = t[0].dims, n = t[0].dataType, o = r.length, i = t[1].dims, a = t[1].dataType, u = k.normalizeAxis(e.axis, o), d = r[u], c = i.slice(0), p = k.size(c), m = O("input", n, o), g = O("indicesInput", a, i.length), y = R("output", n, c.length), b = [
			{
				type: 12,
				data: p
			},
...
`, Fg = (t, e, r) => (() => {
		...
		let a = R("output", t[0].dataType, i.length), u = r.type.value, c = [{
			type: 12,
			data: k.size(i)
		}, ...W(t[0].dims, n, i)], p = (m) => `
...
var Do = V(() => {
	...
	Ue = (t, e) => t.length > e && t[e].dims.length > 0 ? t[e] : void 0, Zg = (t, e) => {
		...
		if (a && k.size(a.dims) > 0) {
			T = 8;
			let D = a.dims;
			throw D.length === 1 ? D[0] === p ? T = 1 : D[0] === 3 * p + 2 && (T = 3) : D.length === 2 && D[0] === p && D[1] === v && (T = 5), T === 8 ? /* @__PURE__ */ new Error("Input \"key_padding_mask\" shape shall be (batch_size) or (batch_size, total_sequence_length)") : /* @__PURE__ */ new Error("Mask not supported");
		}
		let I = !1, E = g;
		...
		let u = [
			...
			let g = R("qkv_with_bias", e.dataType, u), y = O("qkv", e.dataType, u), b = O("bias", r.dataType, u);
			return `
  ${m.registerUniforms([
				{
					name: "output_size",
  ...
  ${m.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
		...
		if (a && k.size(a.dims) > 0) {
			...
			return d = Qg(t, i, a, e, n, r * o, u), d = d.reshape([
				e,
				n,
				r,
				o
			]), r === 1 || n === 1 ? d : t.compute(ze(d, Rl.perm), {
				inputs: [d],
				outputs: [-1]
			})[0];
...
var Bo = V(() => {
	...
	Xg = (t) => {
		...
		return t[1].dims[0] > 0 && (t[1].getBigInt64Array().forEach((o) => r.push(Number(o))), n = r.length), J({
			numOutputs: n,
			axis: e.axis,
			splitSizes: r
		});
...
`)}
		...
		let r = t[0].dims, n = k.size(r), o = t[0].dataType, i = k.normalizeAxis(e.axis, r.length), a = new Array(e.numOutputs), u = O("input", o, r.length), d = new Array(e.numOutputs), c = [], p = [], m = 0, g = [{
			type: 12,
			data: n
		}];
		for (let b = 0; b < e.numOutputs; b++) {
			...
			let _ = r.slice();
			_[i] = e.splitSizes[b], p.push(_), a[b] = R(`output${b}`, o, _.length), c.push({
				dims: p[b],
				dataType: t[0].dataType
			});
		}
...
var Mo = V(() => {
	...
	tb = (t, e) => {
		...
		let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = e, a = t[0].dims[0], u = k.sizeFromDimension(t[0].dims, 1), d = t[0].dims[t[0].dims.length - 2], c = u / d, p = t[2].dims[1], m = o === 0 ? p * 2 : c / n, g = new Array(a, d, c / m, m - p), y = k.computeStrides(g), b = [
			{
				type: 1,
				data: i
			},
...
var Fl = V(() => {
	...
	rb = (t, e) => {
		...
		let T = 0, I = !1, E = e.kvNumHeads ? b * e.kvNumHeads : p;
		...
		return e.dims.length === 3 && r.kvSequenceLength !== 0 && (n = e.reshape([
			...
			o,
			r.headSize
		]), n = t.compute(ze(n, nb.perm), {
			inputs: [n],
			outputs: [-1]
		})[0]), n;
	}, ob = (t, e, r, n) => {
		let o = 7, i = ["type", "type"], a = [t * e], u = t * e, d = [
			{
				type: 12,
				data: u
			},
			...
			let m = O("seq_lens", r.dataType, r.dims), g = O("total_seq_lens", n.dataType, n.dims), y = R("pos_ids", o, a);
			return `
  ${p.registerUniforms([
				{
					name: "output_size",
  ...
  `;
		...
		if (e.doRotary) {
			let I = t.compute(ob(r.batchSize, r.sequenceLength, d, c), {
				inputs: [d, c],
				outputs: [-1]
			})[0], E = t.inputs[7], A = t.inputs[8], D = J({
...
var jl = V(() => {
  ...
  ${v.mainStart(g)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
		...
		let n = e[0].dims, o = n, i = 2, a = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = fe(d), p = k.size(o) / c, m = ql(t, e[0], e[1], e[2], a, d, u, r.epsilon), g = [
			a,
			u,
			d / c
		], y = [a, u], b = ["type", "none"], _ = (S) => {
			let x = O("x", e[0].dataType, g.length, c), v = O("scale_shift", 1, y.length, 2), T = R("output", e[0].dataType, g.length, c), I = [
				x,
				v,
				T
			];
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${T.setByOffset("global_idx", "value")};
		...
		let n = e[0].dims, o = n, i = n[0], a = n[n.length - 1], u = k.sizeFromDimension(n, 1) / a, d = fe(a), c = k.size(o) / d, p = [{
			type: 12,
			data: u
		}, {
			type: 12,
		...
		g = g && n[n.length - 1] !== 1;
		let b = g ? t.compute(ze(t.inputs[0], y), {
			inputs: [t.inputs[0]],
			outputs: [-1]
		})[0] : t.inputs[0].reshape(Array.from({ length: n.length }, (x, v) => n[y[v]])), _ = ql(t, b, e[1], e[2], i, u, a, r.epsilon), S = (x) => {
			let v = we(e[0].dataType), T = d === 1 ? "vec2f" : `mat${d}x2f`, I = (D) => {
				let w = D === 0 ? "x" : "y", U = d === 1 ? "f32" : `vec${d}f`;
				switch (d) {
					case 1: return `${v}(${U}(scale.${w}))`;
					case 2: return `vec2<${v}>(${U}(scale[0].${w}, scale[1].${w}))`;
					case 4: return `vec4<${v}>(${U}(scale[0].${w}, scale[1].${w}, scale[2].${w}, scale[3].${w}))`;
...
var tc = V(() => {
	...
	lb = (t, e) => {
		...
		let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, a = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = fe(a), _ = u.concat([o, a]), S = o > 1 && a / b % 2 === 0 ? 2 : 1, x = k.size(_) / b / S, v = 64, T = [], I = [
			d,
			o,
			i / g
		...
		T.push(...W(A));
		let D = (w) => {
			let U = I.length, N = O("a", t[0].dataType, U, g), F = O("b", 12, E.length, y), q = O("scales", t[2].dataType, t[2].dims.length), Y = [
				N,
				F,
				q
			...
			let L = A.length, Q = R("output", t[0].dataType, L, b), X = we(t[0].dataType), Z = (() => {
				switch (g) {
					case 1: return `array<${X}, 8>`;
					case 2: return `mat4x2<${X}>`;
					case 4: return `mat2x4<${X}>`;
		...
		return {
			name: "MatMulNBits",
			shaderCache: {
				hint: `${e.blockSize};${e.bits};${g};${y};${b};${S};${v}`,
		...
		let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, a = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = u.concat([o, a]), _ = 128, S = a % 8 === 0 ? 8 : a % 4 === 0 ? 4 : 1, x = _ / S, v = Math.floor(32 / e.bits), T = x * y * v, I = T / g, E = T / e.blockSize, A = k.size(b) / S, D = [], w = [
			d,
			o,
			i / g
		], U = k.convertShape(t[1].dims).slice();
		...
		D.push(...W(N));
		let F = (q) => {
			let Y = w.length, z = O("a", t[0].dataType, Y, g), L = O("b", 12, U.length, y), Q = O("scales", t[2].dataType, t[2].dims.length), X = [
				z,
				L,
				Q
			], Z = t.length === 4 ? O("zero_points", 12, t[3].dims.length) : void 0;
...
var nc = V(() => {
	...
	mb = (t) => {
      ...
      `;
		...
		switch (r.mode) {
			case 0: return fb(t, e, r.pads.length);
			case 1: return hb(t, e, r.pads.length);
			case 2: return gb(t, e, r.pads.length);
			case 3: return bb(t, e, r.pads.length);
		...
		let r = k.padShape(t[0].dims.slice(), e.pads), n = t[0].dims, i = [{
			...
			type: 6,
			data: e.pads
		}], a = t.length >= 3 && t[2].data;
		e.mode === 0 && i.push({
			type: a ? t[2].dataType : 1,
			data: e.value
		}), i.push(...W(t[0].dims, r));
		let u = ["rank"], d = (c) => {
			let p = R("output", t[0].dataType, r.length), m = O("x", t[0].dataType, n.length), g = m.type.value, y = yb(p, n.length, e), b = [{
				name: "output_size",
				type: "u32"
			}, {
				name: "pads",
...
var wc = V(() => {
	...
	fn = (t) => {
	...
	}, sc = (t) => `${t.format};${t.ceilMode};${t.autoPad};${t.kernelShape.length}`, $b = (t) => `${sc(t)};${t.countIncludePad}`, vb = (t) => `${sc(t)};${t.storageOrder};${t.dilations}`, uc = (t) => ({
		format: t.format,
		autoPad: [
			"NOTSET",
			"VALID",
		...
		return {
			...
			getShaderSource: (S) => ac(S, a, e.dims.length, i.length, o, d, c, 0, m, g, y, b)
		};
	}, lc = (t) => {
		...
		fn(t.inputs), t.compute(dc("AveragePool", t.inputs[0], !1, e));
	}, pc = {
		autoPad: "",
		ceilMode: 0,
		countIncludePad: !1,
		...
		fn(t.inputs), t.compute(dc("GlobalAveragePool", t.inputs[0], !0, e));
	}, hc = (t, e, r, n) => {
		let [o, i] = oc(e, n, r), a = `
    ...
    `, u = "", d = O("x", e.dataType, e.dims.length), c = ["rank"], [p, m, g, y, b] = ic(i, o);
		return p.push(...W(e.dims, i)), {
			...
			getShaderSource: (_) => ac(_, d, e.dims.length, i.length, o, a, u, e.dataType === 10 ? -65504 : -1e5, m, g, y, b)
		};
	}, gc = (t, e) => {
		fn(t.inputs), t.compute(hc("MaxPool", t.inputs[0], !1, e));
	}, bc = (t) => {
		...
		fn(t.inputs), t.compute(hc("GlobalMaxPool", t.inputs[0], !0, e));
	};
});
var Sb;
var Tb;
...
var Tc = V(() => {
	...
	Ib = (t, e, r) => {
		...
		let o = Math.abs(Math.ceil((e - t) / r)), i = [o], a = o, u = [
			{
				type: 12,
				data: a
			},
...
var Ac = V(() => {
	...
	Ab = (t, e, r, n) => {
		...
		let r = t[0].dims, n = t[1].dims, o = r, i = 1, a = Math.ceil(k.sizeToDimension(n, n.length - 1) / i), u = n[n.length - 1], d = k.sizeFromDimension(r, u), c = [
			{
				type: 12,
				data: a
			},
...
` : "", Lb = (t, e, r, n, o) => {
    ...
    fn bilinearInterpolation(output_indices: ${e.type.indices}) -> ${p} {
      ...
      return (x11 * dx2 * dy2 + x12 * dx2 * dy1 + x21 * dx1 * dy2 + x22 * dx1 * dy1);
		...
		let [g, y] = r.length === 2 ? [0, 1] : [2, 3], b = t.type.value, _ = (S) => {
			let x = S === g ? "row" : "col";
			return `
      ...
      ${v.mainStart()}
        ...
        ${(() => {
			switch (e.mode) {
				...
				case "linear": return `output[global_idx] = ${a.length === 2 || a.length === 4 ? "bilinearInterpolation" : "trilinearInterpolation"}(output_indices);`;
...
`}
		...
		return {
			name: "Resize",
			shaderCache: {
				hint: `${e.cacheKey}|${r}|${c.length > 0 ? e.mode === "cubic" ? c : c.length : ""}|${o.length > 0 ? o : ""}|${u.length > 0 ? u : ""}|${y}|${e.mode === "nearest" ? a.length : a}`,
				inputDependencies: ["rank"]
			},
			getShaderSource: x,
			getRunData: () => ({
...
var Bc = V(() => {
	...
	qb = (t) => {
		...
		let o = e.simplified, i = t[0].dims, a = k.size(i), u = i, d = a, c = i.slice(-1)[0], p = n ? i.slice(0, -1).concat(1) : [], m = !o && t.length > 3, g = t.length > 4, y = n && r > 1, b = n && r > 2, _ = r > 3, S = 64, x = fe(c), v = [
			{
				type: 12,
				data: d
			},
      ...
      ${E.mainStart([
		...
		qb(t.inputs);
		let n = [0];
		t.outputCount > 1 && n.push(-3), t.outputCount > 2 && n.push(-3), t.outputCount > 3 && n.push(3), t.compute(Kb(t.inputs, e, t.outputCount, !1), { outputs: n });
	};
});
var jb;
var hn;
...
var Nc = V(() => {
	...
	jb = (t, e) => {
		...
		if (t.length > 1) {
			...
			return o.length === 0 && (o = [...Array(t[0].dims.length).keys()]), J({
				starts: r,
				ends: n,
				axes: o
			});
		...
		let p = {
			dims: c,
			dataType: t[0].dataType
		}, m = R("output", t[0].dataType, c.length), g = O("input", t[0].dataType, t[0].dims.length), y = k.size(c), b = [
			{
				name: "outputSize",
				type: "u32"
			},
...
var Wc = V(() => {
	...
	Yb = (t) => {
		...
		u ? (c = Array.from({ length: i }, (D, w) => w), c[a] = i - 1, c[i - 1] = a, d = t.compute(ze(r, c), {
			inputs: [r],
			outputs: [-1]
		})[0]) : d = r;
...
var Kc = V(() => {
	...
	ny = (t, e, r, n, o) => {
		...
		return {
			...
			getShaderSource: (c) => ny(c, t, a, i, o),
			getRunData: () => ({
				outputs: [{
					dims: a,
					dataType: o
...
var Zc = V(() => {
	...
	jc = /* @__PURE__ */ new Map([
		...
		["FusedConv", [Ao, Co]],
		["Gather", [wl, _l]],
		["GatherElements", [El, Al]],
		["GatherBlockQuantized", [Tl, Il]],
		["GatherND", [vl, xl]],
		["Gelu", [Gu]],
		["Gemm", [Ol, Pl]],
		["GlobalAveragePool", [fc, mc]],
		["GlobalMaxPool", [_c, yc]],
		["Greater", [yd]],
		["GreaterOrEqual", [wd]],
		["GridSample", [zl, Bl]],
		["GroupQueryAttention", [Hl]],
		["HardSigmoid", [Xu, Qu]],
		["HardSwish", [Yu]],
		["InstanceNormalization", [Kl]],
		["LayerNormalization", [Zl]],
		["LeakyRelu", [Hu, ar]],
		["Less", [_d]],
		["LessOrEqual", [$d]],
		["Log", [sd]],
	...
	iy = (t, e) => {
		...
		run(e, r, n, o, i, a) {
			...
			if (p) {
				...
				this.device.queue.writeBuffer(D.buffer, 0, A, 0, T), this.gpuDataManager.release(D.id), b = {
					offset: 0,
					size: T,
					buffer: D.buffer
				};
	...
	lr = class t {
		...
		if (t === "webgpu") {
			...
			await a.initialize(r, n), o("webgpu", [
				...
				(u, d, c) => a.createKernel(u, Number(d), c, e.UTF8ToString(e._JsepGetNodeName(Number(d)))),
				(u) => a.releaseKernel(u),
				(u, d, c, p) => {
	...
	uy = (t, e) => {
		...
		try {
			...
			for (let I of e?.executionProviders ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
				if (o.shouldTransferToMLTensor = !1, typeof I != "string") {
					...
					D ? o.currentContext = D : w ? o.currentContext = await o.webnnCreateMLContext(w) : o.currentContext = await o.webnnCreateMLContext({
						deviceType: U,
						powerPreference: N
					});
			...
			i = await o._OrtCreateSession(r, n, a), o.webgpuOnCreateSession?.(i), i === 0 && me("Can't create a session."), o.jsepOnCreateSession?.(), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = !0);
			...
			let T = null;
			return v.some((I) => I === "gpu-buffer" || I === "ml-tensor" || I === "ml-tensor-cpu-output") && (u = o._OrtCreateBinding(i), u === 0 && me("Can't create IO binding."), T = {
				handle: u,
				outputPreferredLocations: v,
				outputPreferredLocationsEncoded: v.map((I) => I === "ml-tensor-cpu-output" ? "ml-tensor" : I).map((I) => oo(I))
			}), Ut.set(i, [
				i,
				c,
				p,
		...
		try {
			...
			if (g && !b) {
				...
				wt("wasm bindInputsOutputs"), Ut.set(t, [
					c,
					p,
					m,
					g,
			...
			for (let L = 0; L < S; L++) {
				...
				let X = a.stackSave(), Z = a.stackAlloc(4 * u), ne = !1, ie, le = 0;
				try {
					...
					if (ie === "string") {
						...
						ne = !0, Y.push([
							...
							{
								gpuBuffer: Te,
								download: a.jsepCreateDownloader(Te, qe, ie),
								dispose: () => {
						...
						if (!Te(t, ie, !1)) throw new Error(`preferredLocation "ml-tensor" for ${ie} output is not supported by current WebNN Context.`);
						let Ne = await ge(t, le, M, ke, !1);
						ne = !0, Y.push([
							ie,
							ke,
							{
								mlTensor: Ne,
								download: a.webnnCreateMLTensorDownloader(le, ie),
								dispose: () => {
						...
						let Te = new (Ht(ie))(ve);
						new Uint8Array(Te.buffer, Te.byteOffset, Te.byteLength).set(a.HEAPU8.subarray(le, le + Te.byteLength)), Y.push([
							ie,
							ke,
							Te,
							"cpu"
			...
			g && !y && (a._OrtClearBoundOutputs(g.handle) !== 0 && me("Can't clear bound outputs."), Ut.set(t, [
				c,
				p,
				m,
				g,
...
var Wo = V(() => {
	...
	$t();
	kr();
	Nt = () => !!_e.wasm.proxy && typeof document < "u", cr = !1, yn = !1, _n = !1, Lo = /* @__PURE__ */ new Map(), jt = (t, e) => {
		let r = Lo.get(t);
		...
		switch (t.data.type) {
			case "init-wasm":
				cr = !1, t.data.err ? (_n = !0, Vo[1](t.data.err)) : (yn = !0, Vo[0]()), bn && (URL.revokeObjectURL(bn), bn = void 0);
				break;
			case "init-ep":
			case "copy-from":
			case "create":
		...
		if (!yn) {
			...
			if (cr = !0, Nt()) return new Promise((t, e) => {
				Fe?.terminate(), vs().then(([r, n]) => {
					try {
						...
						!o.in.wasm.wasmPaths && (r || to) && (o.in.wasm.wasmPaths = { wasm: new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href }), Fe.postMessage(o), bn = r;
					} catch (o) {
						e(o);
					}
				}, e);
			...
			try {
				await Pr(_e.wasm), await Or(_e), yn = !0;
			} catch (t) {
				throw _n = !0, t;
			} finally {
				cr = !1;
...
var mp = {};
Wt(mp, {
	OnnxruntimeWebAssemblyBackend: () => $n,
	initializeFlags: () => pp,
	wasmBackend: () => my
});
var pp;
...
*/
//#endregion
export { Pf as InferenceSession, Cr as TRACE, _t as TRACE_EVENT_BEGIN, wt as TRACE_EVENT_END, Ve as TRACE_FUNC_BEGIN, Re as TRACE_FUNC_END, je as Tensor, PT as default, _e as env, Pt as registerBackend };
